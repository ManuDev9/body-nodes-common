...
TEST_CASE(BnTwoNodesMotionTrackingTest) {
    ...
    BnTwoNodesMotionTracking_t test_obj;
    
    BnTwoNodesMotionTracking_create( &test_obj,
        initialPosition, lengthArm1, lengthArm2, locationConstraints, units.c_str()
    );
    BnTwoNodesMotionTracking_compute( &test_obj, test_node1_quat, test_node2_quat, test_ovalues);
...
TEST_CASE(BnRobotIK_ZYY2ArmsTest) {
    ...
    BnRobotIK_ZYY2Arms_t test_obj;
    BnRobotIK_ZYY2Arms_create( &test_obj,
        lengthRA2, lengthRA3, displSP, displEP, units.c_str()
    );
    BnRobotIK_ZYY2Arms_compute( &test_obj, test_endpoint, test_ovalues);
